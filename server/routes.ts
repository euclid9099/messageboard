...
import { getUsers, getUser, editUser, followUser, unfollowUser } from './controllers/user.ts';
import { createPost, getPosts, getPost, editPost, deletePost, likePost, dislikePost } from "./controllers/post.ts";
